...
typedef enum ptp_message_type_e
{
...
#pragma pack(push,1)
typedef struct ptp_message_port_identity_s
{
...
#pragma pack(push,1)
typedef struct ptp_message_header_s
{
...
#pragma pack(push,1)
typedef struct ptp_message_timestamp_s
{
    uint8_t seconds[6];
...
typedef enum ptp_time_source_e
{
...
typedef enum ptp_clock_class_e
{
...
typedef enum ptp_clock_accuracy_e
{
     PTP_CLOCK_ACC_25NS               = 0x20,               /**< Lower Value means better Clock Accuracy */
     PTP_CLOCK_ACC_100NS               = 0x21,               /**< Other Values are Reserved for future use*/
     PTP_CLOCK_ACC_250NS               = 0x22,               /**< */
     PTP_CLOCK_ACC_1US               = 0x23,               /**< */
     PTP_CLOCK_ACC_2_5US               = 0x24,               /**< 2,5 us*/
     PTP_CLOCK_ACC_10US               = 0x25,               /**< */
     PTP_CLOCK_ACC_25US               = 0x26,               /**< */
     PTP_CLOCK_ACC_100US               = 0x27,               /**< */
     PTP_CLOCK_ACC_250US               = 0x28,               /**< */
     PTP_CLOCK_ACC_1MS               = 0x29,               /**< */
     PTP_CLOCK_ACC_2_5MS               = 0x2A,               /**< 2,5 ms*/
     ...
     PTP_CLOCK_ACC_GREATER_10S     = 0x31,               /**< Acc > 10 s*/
     PTP_CLOCK_ACC_UNKNOWN          = 0xFE
} ptp_clock_accuracy_t;

#pragma pack(push,1)
typedef struct ptp_message_clock_quality
{
    uint8_t clock_class;
...
#pragma pack(push,1)
typedef struct ptp_message_announce_s
{
...
#pragma pack(push,1)
typedef struct ptp_message_sync_s
{
    ptp_message_header_t header;
    uint8_t reserved[10];
} ptp_message_sync_t;
...
#pragma pack(push,1)
typedef struct ptp_message_delay_req_s
{
    ptp_message_header_t header;
    ptp_message_timestamp_t origin_timestamp;
...
#pragma pack(push,1)
typedef struct ptp_message_follow_up_s
{
    ptp_message_header_t header;
...
#pragma pack(push,1)
typedef struct ptp_message_delay_resp_s
{
    ptp_message_header_t header;
...
#pragma pack(push,1)
typedef struct ptp_message_pdelay_req_s
{
    ptp_message_header_t header;
    ptp_message_timestamp_t origin_timestamp;
    uint8_t reserved[10];
...
#pragma pack(push,1)
typedef struct ptp_message_pdelay_resp_s
{
    ptp_message_header_t header;
...
#pragma pack(push,1)
typedef struct ptp_message_pdelay_resp_follow_up_s
{
    ptp_message_header_t header;
...
// TODO: Signaling and Management not supported
// #pragma pack(push,1)
// typedef struct ptp_message_signaling_s
// {
//     ptp_message_header_t header;
